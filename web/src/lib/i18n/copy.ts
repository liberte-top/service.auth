...
const copy = {
  en: {
    auth: {
      ...
      profile: {
        ...
        description: "Manage your current Liberte profile details and personal API tokens.",
        eyebrow: "Account",
        fallbackTitle: "Your account",
        subtitle: "Review your identity details, update your display name, and manage personal access.",
        emailLabel: "Email address",
        emailStatusLabel: "Email status",
        emailVerified: "Verified",
        emailUnverified: "Unverified",
        authTypeLabel: "Current auth method",
        principalTypeLabel: "Principal type",
        subjectLabel: "Subject",
        scopesLabel: "Granted scopes",
        securityAction: "Security and sign out",
        detailsEyebrow: "Profile",
        detailsTitle: "Profile details",
        detailsSummary: "Your display name is shown anywhere this auth service needs a friendly account label.",
        clearHint: "Leave blank to clear",
        saveAction: "Save profile",
        updateSuccess: "Profile updated.",
        updateError: "Profile update failed with HTTP {status}.",
      },
      tokens: {
        eyebrow: "API access",
        title: "Personal API tokens",
        summary: "Create a token for scripts or local tooling. The full secret is shown only once.",
        secretLabel: "New token",
        secretHint: "Copy this now. You will not be able to see it again.",
        ...
        scopesHint: "Choose from your current grants.",
        invalidExpiry: "Expiry must be a valid date and time.",
        createAction: "Create token",
        createSuccess: "Token created.",
        createError: "Token creation failed with HTTP {status}.",
        empty: "No personal API tokens yet.",
        ...
        revokedAction: "Already revoked",
        revokeInvalid: "Token id is invalid.",
        revokeSuccess: "Token revoked.",
        revokeError: "Token revoke failed with HTTP {status}.",
      },
      logout: {
        label: "Logout",
  ...
  "zh-CN": {
    auth: {
      ...
      profile: {
        title: "账户设置",
        description: "管理当前 Liberte 会话的资料信息和个人 API Token。",
        eyebrow: "账户",
        fallbackTitle: "你的账户",
        subtitle: "查看身份信息、更新显示名称，并管理个人访问凭证。",
        emailLabel: "邮箱地址",
        emailStatusLabel: "邮箱状态",
        emailVerified: "已验证",
        emailUnverified: "未验证",
        authTypeLabel: "当前认证方式",
        principalTypeLabel: "主体类型",
        subjectLabel: "Subject",
        scopesLabel: "已授予 Scope",
        securityAction: "安全与退出",
        detailsEyebrow: "资料",
        detailsTitle: "资料信息",
        detailsSummary: "显示名称会作为这个认证服务中的友好账户名称使用。",
        clearHint: "留空可清除",
        saveAction: "保存资料",
        updateSuccess: "资料已更新。",
        updateError: "资料更新失败，HTTP 状态码 {status}。",
      },
      tokens: {
        eyebrow: "API 访问",
        title: "个人 API Token",
        summary: "为脚本或本地工具创建 token。完整密钥只会显示一次。",
        secretLabel: "新 Token",
        secretHint: "请立即保存，之后无法再次查看完整值。",
        nameLabel: "Token 名称",
        namePlaceholder: "本地 CLI",
        nameRequired: "Token 名称不能为空。",
        expiryLabel: "过期时间",
        expiryOptional: "选填",
        scopesLabel: "Token Scope",
        scopesHint: "只能从当前已授予的 Scope 中选择。",
        invalidExpiry: "过期时间格式无效。",
        createAction: "创建 Token",
        createSuccess: "Token 已创建。",
        createError: "创建 Token 失败，HTTP 状态码 {status}。",
        empty: "还没有个人 API Token。",
        createdLabel: "创建时间",
        lastUsedLabel: "最近使用",
        expiresLabel: "过期时间",
        statusLabel: "状态",
        statusActive: "有效",
        statusRevoked: "已撤销",
        revokeAction: "撤销 Token",
        revokedAction: "已撤销",
        revokeInvalid: "Token id 无效。",
        revokeSuccess: "Token 已撤销。",
        revokeError: "撤销 Token 失败，HTTP 状态码 {status}。",
      },
      logout: {
        label: "退出",
        title: "退出登录 - Liberte",
